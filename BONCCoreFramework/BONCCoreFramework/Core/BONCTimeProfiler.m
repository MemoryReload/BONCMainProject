...
const NSString *kTimeProfilerResultNotificationName=@"BONCTimeProfilerResult";
const NSString *kNotificationUserInfoKey=@"logArray";
...
@implementation BONCTimeProfiler

+ (BONCTimeProfiler *)sharedTimeProfiler
{
    static dispatch_once_t onceToken;
    static BONCTimeProfiler *profiler = nil;
    dispatch_once(&onceToken, ^{
        profiler = [[BONCTimeProfiler alloc] initTimeProfilerWithMainKey:@""];
    });
    return profiler;
}
...
- (void)saveTimeProfileDataIntoFile:(NSString *)fileName
{
    ...
    BONCLog(@"TMTimeProfiler::SaveFilePath is %@", filePath);
...
- (void)postTimeProfileResultNotification
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:(NSString*)kTimeProfilerResultNotificationName object:nil userInfo:@{kNotificationUserInfoKey:logArray}];
}
