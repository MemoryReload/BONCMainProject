...
@implementation BONCServiceManager
...
{
    NSString *serviceConfigName = [BONCContext shareInstance].serviceConfigName;
...
- (id)createService:(Protocol *)service
{
    ...
    id protocolImpl = [[BONCContext shareInstance] getServiceInstanceFromServiceName:serviceStr];
    if (protocolImpl) {
        return protocolImpl;
    }
    ...
    if ([[implClass class] respondsToSelector:@selector(singleton)]) {
        if ([[implClass class] singleton]) {
            ...
            [[BONCContext shareInstance] addServiceWithImplInstance:implInstance serviceName:serviceStr];
            return implInstance;
        }
    }
